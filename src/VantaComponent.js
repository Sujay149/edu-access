...
import './VantaComponent.css'; // Import the CSS file
    ...
    <div ref={vantaRef} className="vanta-container">
      ...
      <div className="grid">
        ...
        <div className="footer-bottom">
          ...
          <p className="footer-copy">&copy; 2025 EduAccess. All rights reserved.</p>
          <div className="social-links">
            <a href="" className="social-link">Twitter</a>
            <a href="#" className="social-link">Facebook</a>
            <a href='https://www.linkedin.com/in/mohansiva-thota-8b41b4322?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app' aria-label="Instagram Profile" className="social-link">LinkedIn</a>
